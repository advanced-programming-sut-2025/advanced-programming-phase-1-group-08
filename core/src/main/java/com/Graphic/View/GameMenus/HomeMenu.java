            ...
            image.addListener(new ClickListener() {
                ...
                public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                    ...
                    if (!longPressTriggered) {
                        ...
                        body.put("Item", new MarketItem(MarketItemType.Stone));
                        body.put("amount", 25);
                        ...
                        body2.put("Item", new BarsAndOres(BarsAndOreType.CopperOre));
                        body2.put("amount", 20);
...
//                fridge.setVisible(false);
    ...
    private void createInventoryItems(Table content) {
        ...
        for (Map.Entry<Items, Integer> entry : inventory.Items.entrySet()) {
            ...
            Items item = entry.getKey();
            int count = entry.getValue();
            Image itemButton = new Image(TextureManager.get(item.getInventoryIconPath()));
