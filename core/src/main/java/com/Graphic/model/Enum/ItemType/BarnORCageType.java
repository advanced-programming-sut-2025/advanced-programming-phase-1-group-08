...
public enum BarnORCageType {
    ...
    BarnORCageType(String name, int initialCapacity, int width, int height ,int price,int woodNeeded,int stoneNeeded , int shopLimit , String Path) {
        this.name = name;
