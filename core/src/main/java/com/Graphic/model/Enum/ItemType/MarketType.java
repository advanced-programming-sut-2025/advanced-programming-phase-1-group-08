...
public enum MarketType {
    Blacksmith("BlackSmith" , 9 , 16 , 42 , 32 , 6 , 5 ,
                    List.of(new collisionRect(131,56,32,35) , new collisionRect(24,51,75,44) ,
                            ...
                            new collisionRect(23,47,7,17) ) , new collisionRect(0,0,0,0) ,
        new collisionRect(45 * TEXTURE_SIZE,TEXTURE_SIZE ,53 * TEXTURE_SIZE, (TEXTURE_SIZE * 3)/2 )),

    MarnieRanch("Marnie's Ranch" , 9 , 16 , 51 , 32 , 6 , 5,List.of(new collisionRect(0,0,0,0)),
        new collisionRect(206,20,1,24) ,
        new collisionRect(54 * TEXTURE_SIZE,TEXTURE_SIZE,53 * TEXTURE_SIZE, (TEXTURE_SIZE * 3)/2 )),
    ...
    StardropSaloon("The Stardrop Saloon" , 12 , 24 , 32 , 45 , 6 , 5,
                    List.of(new collisionRect(145,45,34,20)   , new collisionRect(34,40,58,30),
                            ...
                            new collisionRect(10,2,45,60)) , new collisionRect(0,0,0,0) ,
        new collisionRect(35 * TEXTURE_SIZE, TEXTURE_SIZE,40 * TEXTURE_SIZE,(TEXTURE_SIZE * 3)/2)),

    CarpenterShop("Carpenter's shop" , 9 , 20 , 51, 38 , 6 , 5 ,
        List.of(new collisionRect(0,0,0,0)) , new collisionRect(95,24,8,24) ,
        new collisionRect(54 * TEXTURE_SIZE, TEXTURE_SIZE,47 * TEXTURE_SIZE,(TEXTURE_SIZE * 3)/2)),
    ...
    JojaMart("JojaMart" , 9 , 23 , 32 , 38 , 6 , 5 ,
                    List.of(new collisionRect(0 ,45,40,82)    , new collisionRect(70,38,40,72),
                            ...
                            new collisionRect(20,16,171,24)   ) , new collisionRect(191,67,-42,23) ,
        new collisionRect(35 * TEXTURE_SIZE, TEXTURE_SIZE,47 * TEXTURE_SIZE,(TEXTURE_SIZE * 3)/2)),
    ...
    PierreGeneralStore("Pierr's General Store" , 9 , 17 , 32 , 32 , 6 , 5 ,
                    List.of(new collisionRect(16,27,48,45)    , new collisionRect(40,40,48,42),
                            ...
                            new collisionRect(100,100,100,100) ,
        new collisionRect(35 * TEXTURE_SIZE, TEXTURE_SIZE,53 * TEXTURE_SIZE,(TEXTURE_SIZE * 3)/2)),
    ...
    FishShop("Fish shop" , 9 , 17 , 42 , 38 , 6 , 5 ,
                    List.of(new collisionRect(36,25,28,61)    , new collisionRect(61,48,62,27),
                            ...
                            new collisionRect(161,24,22,55))  , new collisionRect(0,0,0,0) ,
        new collisionRect(45 * TEXTURE_SIZE, TEXTURE_SIZE,47 * TEXTURE_SIZE,(TEXTURE_SIZE * 3)/2)),;
