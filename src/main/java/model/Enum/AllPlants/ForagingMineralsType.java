...
public enum ForagingMineralsType {
    ...
    IRON            (BRIGHT_BLACK+"I"+RESET, 10,   WHITE+"A fairly common ore that can be smelted into bars."+RESET,                            Math.random() < 0.15),
    ...
    COPPER          (BRIGHT_BLACK+"C"+RESET, 5,    WHITE+"A common ore that can be smelted into bars."+RESET,                                   Math.random() < 0.15),
